...
namespace PaintingSellingBot
{
	public class Events
	{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnWebAppsHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnPollHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnContactHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnLocationHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnVenueHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <summary>
		/// Обработка_Не верный тип чата
		/// </summary>
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnWrongTypeChat(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <summary>
		/// Обработка_Не найдена команда
		/// </summary>
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnMissingCommand(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <summary>
		/// Событие_Проверка привилегий пользователя
		/// </summary>
		...
		public static async Task OnCheckPrivilege(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update,
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnGameHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnDiceHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnUnknownHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
			//Обработка данных
		...
		/// <summary>
		/// Обработка_Не правильный тип сообщений
		/// </summary>
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnWrongTypeMessage(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnVoiceHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnAudioHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnStickerHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnPhotoHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnVideoHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		public static async Task OnVideoNoteHandle(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update)
		{
		...
		/// <summary>
		/// Обработка_Пользователь написал в чат start с deeplink (с аргументом)
		/// </summary>
		/// <param name="botclient">Текущий запущенный клиент бота</param>
		/// <param name="update">Обновление от бота</param>
		/// <param name="args">Сообщение при первом запуске бота</param>
		public static async Task OnUserStartWithArgs(
			Telegram.Bot.ITelegramBotClient botclient,
			Telegram.Bot.Types.Update update,
			string args)
		{
